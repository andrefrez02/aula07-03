...
if media >= 7:
    print(f'\n{nome} passou em {curso} com uma média de: {media:.5} PARABÉNS!!!')
elif media >= 5 and media < 7:
    print(f'\n{nome} ficou de recuperação em {curso} com uma média de: {media:.5} FAÇA O EXAME FINAL!!!')
else:
    print(f'\n{nome} não passou em {curso} com uma média de: {media:.5} ESTUDE MAIS!!!')